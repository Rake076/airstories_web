            ...
            <div class="container-fluid m1">
              <div class="row mb-2">
                <div class="col-sm-6">
                  ...
                  <!-- <button class=" btn m-1 btn-xs btn-outline-warning ">
           ...
           <div class="container-fluid">
               ...
               <form method="post"enctype='multipart/form-data'>
                 ...
                 <div class="form-row">
                   <div class="form-group col-md-4">
                     ...
                     <input type="text" class="form-control form-control-sm"name="chapter_name"value="<?php echo $chapter_name ?>"  placeholder="Chapter Tittle">
                   </div>
                 ...
                 <div class="row">
                   <div class="col-md-2 offset-5">
                     <button type="submit"name="save_chapter" class="btn btn-success btn-block btn-sm m-2 float-right">Save</button>
                   </form>
                   </div>
                 </div>
                 </div>
            ...
            <div class="row">
              ...
              ?>
               ...
               <div class="col-md-12"> <!-- /.col -->
              <table class="table table-bordered table-sm text-dark"id="sampleTable" >
                <thead>
                  <tr>
                    <th> Story Tittle </th>
                     <th> Chapter Name </th>
                      ...
                      <tr>
                        <td>
                          <span class="badge badge-primary badge-pill">
                           <?php
                              echo '<a href="story_details.php?story_details='.$id.' "target="_blank" class="text-dark text-capitalize">'.$b_tittle.'</a>';
                              ?>
                            </span>
                          </td>
                          <td>
                        <?php
                          ...
                          |
                           ...
                           ?>
                           |
                           <a class="delete float-right" href="add_chapters.php?delete=<?php echo $id; ?>">|  Delete  |</a>
