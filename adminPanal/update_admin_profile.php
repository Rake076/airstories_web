                 ...
                 $id = $_GET['edit'];
                  ...
                  <div class="container ">
                                 ...
                                 <div class="col-md-12">
                                     <div class="form-group row">
                                       <div class="col-sm">
                                         <?php
                                         if($profile_image) {
                                            echo '<img class="profile-user-img img-fluid"src="../adminprofileImage/'.$profile_image.'"height="100px">';
                                            }else{
                                     ...
                                     <div class="form-group row">
                                       ...
                                       <input type="file"name="profile_image" class="form-control form-control-sm" id="colFormLabelSm" placeholder="">
                                     </div>
                   ...
                   <div class="modal-footer justify-content-between float-right">
                    <button type="submit"name="update_admin_profile" class="btn btn-sm btn-outline-danger ">Save changes</button>
                  </div>
