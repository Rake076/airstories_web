              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"> Journalism </li>
                  </ol>
                </div><!-- /.col -->
              </div><!-- /.row -->
              <hr>
              <a href="create_journal.php"class="btn btn-danger btn-outline-success">Create New</a>
              <a href="view_all_journal.php"class="btn btn-warning btn-outline-danger">View All journals</a>
              <hr>
            </div><!-- /.container-fluid -->
          </div>
          <!-- /.content-header -->
                 ...
                 <?php
                  ...
                  <table class="table  table-hover  table-responsive table-sm"id="sampleTable" >
                    <thead>
                      ...
                      <tbody>
                        <?php
                         $query="select * from journals where author_id='$admin_id'";
