        ...
        <div class="content-wrapper">
          ...
          <div class="content-header">
            <div class="container-fluid m1">
              <div class="row mb-2">
                <div class="col-sm-6">
                  <h1 class="m-0 text-dark text-muted text-lg">Completed Stories </h1>
                <span class="text-muted text-sm" > Total Stories :</span> <kbd class="bg-success rounded-circle"><?php  $obj->completed_story('stories'); ?></kbd>
