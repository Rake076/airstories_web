                    ...
                    <div class="login-inner-form">
                        <form  method="POST">
                            ...
                            <div class="form-group form-box">
                                <input type="email" name="email"value="<?php echo $email; ?>"autocomplete="off" class="input-text" placeholder="Email Address">
                                <i class="fa fa-envelope"></i>
                            </div>
                            <div class="form-group form-box">
                                <input type="password" name="password"value=""autocomplete="off" class="input-text" placeholder="Password">
