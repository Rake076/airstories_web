        ...
        <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-12 bg-color-10">
                <div class="form-section">
                             ...
                             <form  method="POST">
                                 <div class="form-group form-box">
                                   <label for="">Enter Your Email</label>
                                     <input type="email" name="email"value="<?php echo $email; ?>"autocomplete="off" class="input-text" placeholder="">
                    ...
                    <p>Don't have an account? <a href="register.php" class="thembo text-primary"> Register here</a> / <a href="login.php" class="thembo text-primary"> Login here</a></p>
                </div>
            </div>
