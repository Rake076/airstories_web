...
if (isset($_POST['save_journal'])) {
  ...
  if (count($errors) == 0) {
   	$query = "INSERT INTO journals (tittle,type,jdate,detail,cover_photo,author,author_id,readings,likes,comments)
  			  VALUES('$tittle','$type','$jdate','$detail','$cover_photo','$author','$author_id','$readings','$likes','$comments')";
