              ...
              <div class="row">
                <div class="col-md-12">
                   <div class="container-fluid">
                     <div class="row">
                       <div class="col-md-4">
                         <img class="profile-user-img img-fluid zoom"src="../coverphotos/<?php echo $cover_photo; ?>"height="100px">
                          <hr>
                        </div> <!--main row -->
                         ...
                         <div class="row">
                           <div class="col-md-3">
                                 ...
                                 <div class="text-center">
                                   <?php
                                     if($cover_photo) {
                                       ...
                                       echo'
                                       <div class="middle">
                                         <a href="#" class="text-danger">Book Not Exist</a>
                                       </div>
                                       ';
                                     }
                                    ?>
                             ...
                             <div class="card">
                               ...
                               <div class="card-body box-profile">
                                 <?php
                                    $s = 'select * from storychapters where s_id='.$storyid.'';
                                       $r = mysqli_query($connection,$s);
                                         while ($row=mysqli_fetch_assoc($r)) {
                                         $id = $row['id'];
                                         $chapter_name = $row['chapter_name'];
                                 ...
                                 <div class="col-md-12">
                                   <table class="table table-bordered table-hover "id="reviewTable" >
                                     <thead>
                                       ...
                                       <tbody>
                                         <?php
                                            $s = 'select * from comments where book_id='.$storyid.'';
                                              $r = mysqli_query($connection,$s);
                                                while ($row=mysqli_fetch_assoc($r)) {
                                                  $id = $row["id"];
                                                   $book_id = $row["book_id"];
                                 ...
                                 <div class="col-md-12">
                                   <table class="table table-bordered table-hover table-sm"id="sampleTable" >
                                     <thead>
                                       ...
                                       <tbody>
                                         <?php
                                            $s = 'select * from reviews where book_id='.$storyid.'';
                                              $r = mysqli_query($connection,$s);
                                                while ($row=mysqli_fetch_assoc($r)) {
                                                  $id = $row["id"];
                                                   $book_id = $row["book_id"];
                           ...
                           <!-- /.Reports section start here  -->
                             <div class="row card">
                               <h5 class="text-muted m-2">Story Reports </h5>
                                <hr>
                                 <div class="col-md-12">
                                   <table class="table table-bordered table-hover table-sm"id="reportTable" >
                                     <thead>
                                       ...
                                       <tbody>
                                         <?php
                                            $s = 'select * from reports where book_id='.$storyid.'';
                                              $r = mysqli_query($connection,$s);
                                                while ($row=mysqli_fetch_assoc($r)) {
                                                  $id = $row["id"];
                                                   $book_id = $row["book_id"];
