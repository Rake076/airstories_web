                ...
                <table class="table table-hover table-responsive table-sm"id="sampleTable" >
                  <thead class="text-danger">
                    ...
                    <tbody class="text-sm text-muted">
                      <?php
                      $s = "select * from stories where user_id='$admin_id'";
                        ...
                        <tr>
                             ...
                             <td><?php echo substr($b_description,0,45).'...';  ?></td>
                             ...
                             <?php
                              if ($status == 1) {
                                echo "<td><a class='badge badge-danger text-warning'> Un-Published  </a> </td>";
                                }else {
                                 echo "<td><a class='badge badge-success text-warning'> Published  </a> </td>";
                               }
                             ?>
