                                                          ...
                                                          if (mysqli_num_rows($results) == 1) {
                                                           ...
                                                           ?>
                                                            <div class="user d-flex flex-row align-items-center">
                                                                <?php
                                                                if (mysqli_num_rows($results) == 1) {
                                                                       echo '<img src="../userprofileImage/'.$profile.'" width="30" class="user-img rounded-circle mr-2">';
                                                                       }else{
                                                                      echo '<img src="../userprofileImage/profile.png" width="30" class="user-img rounded-circle mr-2">';
                                                                    }
                                                                  ?>
