              ...
              <div class="row mb-2">
                <div class="col-sm-6">
                  ...
                  $u_email = $_SESSION['u_email'];
                   ...
                   ?>
                  <span class="text-muted">Total Journals :</span> <kbd class="bg-success rounded-circle"><?php
                   ...
                   <div class="">
                     <form method="post"enctype="multipart/form-data">
                       ...
                       <div class="col-sm-6">
                         ...
                         <input type="hidden"class="form-control"name="author"value="<?php echo $frist_name.' '.$last_name; ?>" placeholder="Author Name">
                         <input type="hidden"class="form-control" name="author_id"value="<?php echo $userid; ?>" placeholder="Author ID">
                       ...
                       <div class="row">
                          <div class="col-md-8 offset-2">
                            <div class="form-group">
                              ...
                              <textarea id="" class="form-control"name="detail" placeholder="write Details"cols="15" rows="5"><?php echo $detail ?></textarea>
<!--                               <script>
                                  $(function () {
