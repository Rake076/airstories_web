                  ...
                  <table class="table  table-hover  table-responsive table-sm"id="sampleTable" >
                    <thead>
                      ...
                      <tbody>
                        ...
                        $u_email = $_SESSION['u_email'];
                         $u_password = $_SESSION['u_password'];
                         $query="select * from journals where author_id='$id'";
                         ...
                         ?>
                          <tr>
                               ...
                               <?php
                                // if ($status == 1) {
                                //   echo "<td><a class='badge badge-success publish text-warning' href='view_journal.php?journal_status1=$id'> Unpublished  </a> </td>";
                                //   }else {
                               ...
                               <td> <a href="update_journal.php?edit=<?php echo $id  ?>">Edit</a> </td>
                          </tr>
                        <?php  } } ?>
                     </tbody>
                  </table>
