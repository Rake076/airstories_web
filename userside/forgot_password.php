                             ...
                             <form  method="POST">
                                 <div class="form-group form-box">
                                   <label for="">Enter Your Email</label>
                                     <input type="u_email" name="u_email"value="<?php echo $u_email; ?>"autocomplete="off" class="input-text" placeholder="">
                                     <i class="flaticon-mail-2"></i>
                                 </div>
                                 <div class="form-group">
                                     <button type="submit" name="set_password" class="btn-md btn-theme btn-block">Reset Password</button>
                                 </div>
                             </form>
                         </div>
                    <p>Don't have an account? <a href="register.php" class="thembo text-primary"> Register here</a> / <a href="user_login.php" class="thembo text-primary"> Login here</a></p>
                </div>
            </div>
