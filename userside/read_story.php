            ...
            if($_SESSION["u_email"] && $_SESSION["u_password"]==true ){
                $query = "SELECT * FROM users WHERE u_email='$u_email' AND u_password='$u_password'";
                 ...
                 if (mysqli_num_rows($results) == 1) {
                    ...
                    $commenti_id =$row['id'];
                   $reviewi_id =$row['id'];
                   $userid =$row['id'];  // sending id to story Recommendation dropdown to remove all users except current user or loged in user
                }
              }
            }
           ?>
                 ...
                 <div class="card text-center">
                   ...
                   <!-- displaying the comment start here -->
                       <div class="row">
                           <div class="col-md-10 offset-1">
                             <?php
                          $s = "select * from comments where book_id='$story_id' and commenti_id='$userid'";
                                    $r = mysqli_query($connection,$s);
                                     while ($row=mysqli_fetch_assoc($r)) {
                                       $id = $row["id"];
                                        $book_id = $row["book_id"];
                               ...
                               <div class="card p-3">
                                   <div class="d-flex justify-content-between align-items-center">
                                     <?php
                                     $query = "SELECT * FROM users WHERE id='$commenti_id'";
                                     $results = mysqli_query($connection, $query);
                                     if (mysqli_num_rows($results) == 1) {
                                         while ($row=mysqli_fetch_assoc($results)) {
                                             $commenti_id =$row['id'];
                        ...
                        <div class="col-md-8 offset-2">
                          <form method="post"enctype='multipart/form-data'>
                            <div class="form-row">
                              ...
                              <div class="form-row">
                                <div class="form-group col-md-12">
                                  <input type="hidden" class="form-control form-control-sm"name="commenti_id"value="<?php echo $userid; ?>"  placeholder="">
                                </div>
                                </div>
                              <div class="form-row">
                              <div class="form-group col-md-12">
         ...
         <div class="row">
            <div class="col-md-12">
              <div class="form-row">
                ...
                <div class="form-row">
                  <div class="form-group col-md-4">
                    <input type="hidden" class="form-control form-control-sm"name="reporti"value="<?php echo $reviewi_id; ?>"  placeholder="">
                  </div>
                  </div>
                <div class="form-row">
                <div class="form-group col-md-4">
   ...
   <div class="row">
      <div class="col-md-12">
        <div class="form-row">
          ...
          <div class="form-row">
            <div class="form-group col-md-4">
              <input type="hidden" class="form-control form-control-sm"name="sid"value="<?php echo $userid; ?>"  placeholder="">
            </div>
          </div>
          <div class="form-row">
          <div class="form-group col-md-4">
            ...
            <br>
             <?php
              $query = "SELECT * FROM users Except SELECT * FROM users WHERE id =$userid";
                $results = mysqli_query($connection, $query);
                    while ($row=mysqli_fetch_assoc($results)) {
                         $id =$row['id'];
                         $frist_name =$row['frist_name'];
