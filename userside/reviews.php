                    ...
                    $u_email = $_SESSION['u_email'];
                     $u_password = $_SESSION['u_password'];
                      if($_SESSION["u_email"] && $_SESSION["u_password"]==true ){
                       ...
                       $sql = "SELECT count(*) FROM reviews where reviewi_id='$reviewi_id'";
           ...
           <div class="container-fluid">
            ...
            <div class="row">
             <div class="col-md-12"> <!-- /.col -->
               <form method="post"enctype='multipart/form-data'class="text-muted text-sm">
                 <div class="form-row">
                   ...
                   $u_email = $_SESSION['u_email'];
                    $u_password = $_SESSION['u_password'];
                     if($_SESSION["u_email"] && $_SESSION["u_password"]==true ){
                       ...
                       ?>
                   <input type="hidden" name="reviewi_id" value="<?php echo $reviewi_id ?>">
                 <?php } } } ?>
                   ...
                   <div class="form-group col-md-8">
                     ...
                     <textarea name="review"class="form-control form-control-sm" rows="4" cols="40"><?php echo $review ?></textarea>
                   </div>
                 </div>
                 <div class="row">
            ...
            <div class="row">
               <div class="col-md-12"> <!-- /.col -->
                <?php
                 ...
                 ?>
                <table class="table table-bordered table-hover table-sm text-muted text-sm"id="sampleTable" >
                  <thead>
                    <tr>
                      <th> BOOK/Story </th>
                    ...
                    <tbody>
                      <?php
                         $u_email = $_SESSION['u_email'];
                           $u_password = $_SESSION['u_password'];
                             if($_SESSION["u_email"] && $_SESSION["u_password"]==true ){
                               $query = "SELECT * FROM reviews WHERE  reviewi_id='$reviewi_id'";
                                 $results = mysqli_query($connection, $query);
                                  if (mysqli_num_rows($results) == 1) {
                                   while ($row=mysqli_fetch_assoc($results)) {
                                   $id = $row["id"];
